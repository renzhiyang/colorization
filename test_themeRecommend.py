...
def test_theme_Recommend():
    ...
    input_gray = get_image(input_image, type = "jpg", channel = 1)
    ...
    plt.subplot(1, 2, 1), plt.imshow(grayImage)
    plt.subplot(1, 2, 2), plt.imshow(theme)
    plt.show()
